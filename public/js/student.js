function studentfunction(){
    var input_starttime=document.getElementById("starttime").value;
    var input_price=document.getElementById("price").value;
    var input_endtime=document.getElementById("endtime").value;
    var input_classtime=document.getElementById("classtime").value;
